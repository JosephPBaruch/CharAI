...
The project schedule outlines the planned timeline and major milestones for CharAI’s development. It is designed to keep the team aligned across model training, system integration, and deployment phases.
...
![Gantt Chart](/docs/03_Project_Management/Schedule/GanttSchedule.drawio.svg)
