        ...
        >
          <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
            ...
            >
              <Typography
                variant="caption"
                sx={{ color: COLORS.blackFull, fontWeight: 600 }}
              >
                Required
              </Typography>
            </Box>
          ...
          <Typography variant="body2" sx={{ color: COLORS.whiteMedium, mb: 2 }}>
            Upload a file containing your farm boundary coordinates, or draw
            them manually.
          </Typography>
          <CoordinateFileUpload
            onSelect={onCoordSelect}
            onUploadComplete={onCoordUploaded}
          />
          <Typography
            variant="caption"
            sx={{ color: COLORS.whiteMedium, my: 1.5, display: "block" }}
          >
        ...
        >
          <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
            ...
            >
              <Typography
                variant="caption"
                sx={{ color: COLORS.whiteMedium, fontWeight: 600 }}
              >
                Optional
              </Typography>
            </Box>
          ...
          <Typography variant="body2" sx={{ color: COLORS.whiteMedium, mb: 2 }}>
            Upload historical yield data to enable yield-based calculations and
            recommendations. This helps predict potential ROI from biochar
            applications.
          </Typography>
          <YieldFileUpload
            onSelect={onYieldSelect}
            onUploadComplete={onYieldUploaded}
          />
          <Typography
            variant="caption"
            sx={{ color: COLORS.whiteMedium, mt: 1.5, display: "block" }}
          >
